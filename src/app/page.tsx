      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {topics.map((topic) => (
            ...
            >
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 border border-gray-100 hover:border-gray-200 group h-full">
                <div className={`text-5xl mb-4 bg-gradient-to-r ${topic.color} p-3 rounded-xl group-hover:scale-110 transition-transform duration-300 inline-block`}>
                  {topic.icon}
                </div>
